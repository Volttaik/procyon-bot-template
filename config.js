...
module.exports = {
    ...
    BOT_NAME:              process.env.BOT_NAME || "Procyon Bot",
    OWNER_NUMBER:          process.env.OWNER_NUMBER || "",
    OWNER_NAME:            process.env.OWNER_NAME || "Owner",
    DESCRIPTION:           process.env.DESCRIPTION || "Procyon WhatsApp Bot",
    ALIVE_IMG:             process.env.ALIVE_IMG || "https://files.catbox.moe/5uli5p.jpeg",
    LIVE_MSG:              process.env.LIVE_MSG || "Procyon Bot is active ⚡",
    ...
    AUTO_STATUS_MSG:       process.env.AUTO_STATUS_MSG || "Seen by Procyon Bot",
    ...
    STATUS_MSG:            process.env.STATUS_MSG || 'PROCYON BOT ⚡ SUCCESSFULLY VIEWED YOUR STATUS',
    ...
    THEME:                 (process.env.THEME || 'procyon').toLowerCase().trim(),
    GREETING:              process.env.GREETING || '',
    APP_URL:               process.env.APP_URL || '',

    PROCYON_BOT_ID:        process.env.PROCYON_BOT_ID || '',
    PROCYON_API_URL:       process.env.PROCYON_API_URL || '',
    PROCYON_API_KEY:       process.env.PROCYON_API_KEY || '',
